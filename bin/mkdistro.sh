...
mvn -Dhttp.proxyHost=proxy01.cd.intel.com -Dhttp.proxyPort=911 -Dhttps.proxyHost=proxy01.cd.intel.com -Dhttps.proxyPort=911 -DskipTests clean package -Phadoop-3 assembly:single ${MVN_OPTS} "$@"
